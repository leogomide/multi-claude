...
export const MainMenuScene: React.FC = () => {
	...
	return (
		<div style={{ width: "100%", height: "100%", position: "absolute", opacity: fadeIn }}>
			...
			{showDownKey && <KeyIndicator label="↓" frame={frame} startFrame={cursorFrame - 5} />}
			{showEnterKey && <KeyIndicator label="⏎" frame={frame} startFrame={selectFrame - 5} />}
			...
			<TextOverlay text="Select your preferred AI provider" startFrame={10} durationFrames={120} />
		</div>
	);
};
