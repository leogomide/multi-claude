...
export const es: TranslationDictionary = {
	...
	statusLine: {
		...
		full: "Completa",
		fullDesc: "Tres l\u00edneas: modelo + barra de contexto, tokens + I/O + burn rate, sesi\u00f3n + git",
		slim: "Slim",
		slimDesc: "Dos l\u00edneas: modelo + barra de contexto, tokens + costo + sesi\u00f3n + git",
		mini: "Mini",
		...
		dev: "Desarrollador",
		devDesc: "Enfocado en dev: branch, worktree, agente y l\u00edneas modificadas en la primera l\u00ednea. Modelo, contexto y costo compactos en la segunda",
		perf: "Rendimiento",
