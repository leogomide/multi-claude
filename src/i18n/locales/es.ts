...
export const es: TranslationDictionary = {
	...
	statusLine: {
		...
		full: "Completa",
		fullDesc: "Tres l\u00edneas: todas las m\u00e9tricas \u2014 contexto, tokens, costo, duraci\u00f3n, l\u00edneas cambiadas",
		progress: "Progreso",
		progressDesc: "Tres l\u00edneas: barra de progreso del contexto + tokens, costo, duraci\u00f3n, l\u00edneas cambiadas",
		gauge: "Medidor",
		gaugeDesc: "Una l\u00ednea: barra de contexto amplia con porcentaje y costo",
		budget: "Presupuesto",
		budgetDesc: "Una l\u00ednea: costo como m\u00e9trica principal con tokens y contexto %",
		context: "Contexto",
		contextDesc: "Dos l\u00edneas: barra de contexto amplia (40 chars) + desglose de tokens y capacidad restante",
		engineer: "Ingeniero",
		engineerDesc: "Dos l\u00edneas: proyecto, rama git, l\u00edneas cambiadas + barra de contexto, costo, duraci\u00f3n",
		cashflow: "Cashflow",
		cashflowDesc: "Dos l\u00edneas: costo/min (tasa de gasto), tiempo de API + desglose de tokens con barra",
		compact: "Compacta",
		compactDesc: "Una l\u00ednea: modelo, contexto %, costo, duraci\u00f3n, rama git",
		boxed: "Enmarcada",
		boxedDesc: "Tres l\u00edneas: marco con proveedor, barra, tokens, costo, git",
		ratio: "Raz\u00f3n",
		ratioDesc: "Una l\u00ednea: raz\u00f3n I/O de tokens y porcentaje de cache hit",
		worktree: "Worktree",
		worktreeDesc: "Dos l\u00edneas: encabezado con worktree/agent + barra de contexto, costo, l\u00edneas cambiadas",
	...
	cliFlags: {
		title: "Seleccione flags de CLI (opcional)",
		groupSession: "Sesión",
		...
		descChrome: "Habilitar integración con Chrome para automatización web",
