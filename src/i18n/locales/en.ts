...
export const en: TranslationDictionary = {
	...
	statusLine: {
		...
		full: "Full",
		fullDesc: "Three lines: model + context bar, tokens + I/O + burn rate, session + git",
		slim: "Slim",
		slimDesc: "Two lines: model + context bar, tokens + cost + session + git",
		mini: "Mini",
		...
		dev: "Developer",
		devDesc: "Dev-focused: branch, worktree, agent and lines changed on the first line. Model, context and cost compact on the second",
		perf: "Performance",
