...
export const en: TranslationDictionary = {
	...
	statusLine: {
		...
		full: "Full",
		fullDesc: "Three lines: all metrics — context, tokens, cost, duration, lines changed",
		progress: "Progress",
		progressDesc: "Three lines: context progress bar + tokens, cost, duration, lines changed",
		gauge: "Gauge",
		gaugeDesc: "Single line: wide context bar with percentage and cost",
		budget: "Budget",
		budgetDesc: "Single line: cost as primary metric with tokens and context %",
		context: "Context",
		contextDesc: "Two lines: wide context bar (40 chars) + token breakdown and remaining capacity",
		engineer: "Engineer",
		engineerDesc: "Two lines: project, git branch, lines changed + context bar, cost, duration",
		cashflow: "Cashflow",
		cashflowDesc: "Two lines: cost/min burn rate, API time + token breakdown with context bar",
		compact: "Compact",
		compactDesc: "Single line: model, context %, cost, duration, git branch",
		boxed: "Boxed",
		boxedDesc: "Three lines: box-drawing frame with provider, bar, tokens, cost, git",
		ratio: "Ratio",
		ratioDesc: "Single line: I/O token ratio and cache hit percentage",
		worktree: "Worktree",
		worktreeDesc: "Two lines: worktree/agent-aware header + context bar, cost, lines changed",
	...
	cliFlags: {
		title: "Select CLI flags (optional)",
		...
		worktree: "--worktree",
		chrome: "--chrome",
		descResume: "Resume a previous session (interactive picker)",
		...
		descChrome: "Enable Chrome browser integration for web automation",
