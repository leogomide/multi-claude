...
export const en: TranslationDictionary = {
	...
	editProvider: {
		...
		editUrl: "Edit URL",
		editAuthVar: "Edit authentication",
		manageModels: "Manage models",
		...
		authVarUpdated: "Authentication updated to {{authVar}}.",
	},
	settings: {
		title: "Settings",
		openConfigFolder: "Open config folder",
	...
	sidebar: {
		...
		models: "Models",
		baseUrl: "Base URL",
		baseUrlUserDefined: "set by you",
		modelsUserDefined: "added by you",
		source: "Source",
	...
	update: {
		...
		failed: "Update failed. Try manually: {{command}}",
		permission:
			"The global folder of {{manager}} needs administrator rights. Run in an elevated terminal (Windows) or with sudo, or point the prefix to a user folder, then: {{command}}",
